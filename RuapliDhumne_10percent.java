   ...
   public static void main(String[] args) throws Exception //if still OOM subtract as you bring it in
   {
      ...
      {      
          for(int x=0; x<nIterations; x++) 
         {
            ...
            filename= "/Users/rdhumne/Documents/GMUInternship2015/S6_txt/S6_"+ dataFile + (j+3)+ "_"+ (x+1) + "_f" + (a+1) + ".txt"; //getting textfile //add NewMotions/
            ...
            { 
             ...
             filename= "/Users/rdhumne/Documents/GMUInternship2015/S6_txt/S6_"+ dataFile + (j+3)+ "_"+ (x+1) + "_f" + (a+1) + ".txt";
