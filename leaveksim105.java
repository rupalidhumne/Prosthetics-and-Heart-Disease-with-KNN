...
public class leaveksim105
{
   ...
   static final int nActions = 5;
   static final int nIterations =2 ;

   static int nFrames=40; //# frames = # files
   ...
   static File file;
   static int[][] valMatrix = new int[11][11];
   ...
   public static void main(String[] args) throws Exception //if still OOM subtract as you bring it in
   {
      ...
      {      
          for(int x=0; x<nIterations; x++) 
         {
            ...
            filename= "/Users/rdhumne/Documents/GMUInternship2015/S8_txt/S8_"+ dataFile + (j+3)+ "_"+ (x+1) + "_f" + (a+1) + ".txt"; //getting textfile //add NewMotions/
            ...
            { 
             ...
             filename= "/Users/rdhumne/Documents/GMUInternship2015/S8_txt/S8_"+ dataFile + (j+3)+ "_"+ (x+1) + "_f" + (a+1) + ".txt";
      ...
      System.out.println("correlationTime:" + (double)corrTime / 1000000000/((nActions*nIterations)*((nActions*nIterations)-1))); //40 test instances are each correlated to their 39 other 39 test instances
      System.out.println("patternTime:" + (double)patternTime / 1000000000/((nActions*nIterations)*(nActions*nIterations))); //1 activity patern is the test, 39 activity patterns are the train, this happens 40 tims
  ...
  public static void report(ArrayList<Instancem> iterations)
   {
   ...
   }  public static int nearestNeighbor(int test, ArrayList<Instancem> train)
    {
      ...
      //System.out.println("c: " + iterations.get(test).getS() + "first 3: " + ccs.get(0) + ccs.get(1)+ ccs.get(2) );
      return ccs.get(0);
    }
