...
public class regionksim105
{
   ...
   static final int nIterations =3 ;
  ...
  public static void report(ArrayList<Instancem> iterations)
   ...
   }   public static int nearestNeighbor(int test, ArrayList<Instancem> train)
   {
	   ...
	   ArrayList<Double> corrs = new ArrayList<Double>();
	      ...
	      double time1 = System.nanoTime();
	      Double[] avg1= to1d(iterations.get(test).task3());
	      ...
	      for(int x=0; x<train.size(); x++)
	      {
	          if(x!=test)
	          {
		    	  ...
		    	  Double[] avg2= to1d(iterations.get(test).task3());
  ...
  public static Double[] to1d(Double[][] matrix)
  {
  ...
  {
       	double meanA=mean(avg1);
           double meanB=mean(avg2);
           double top = top(meanA, meanB, avg1, avg2);
           double bottom = bottom(meanA, meanB, avg1, avg2);  
  ...
  public static double bottom(double ma, double mb, Double[] a, Double[] b)
  {
     ...
     for(int x=0; x<a.length; x++)
     {
   	  ...
   	  sumA+=Math.pow((a[x]-ma),2);
          sumB+=Math.pow((b[x]-mb),2);
     } 
