...
public class hamming 
{
	...
	static ArrayList<InstanceHamming> iterations;
	   ...
	   static final int nActions = 3;
	   static final int nIterations =2 ;

	   static int nFrames=50; //# frames = # files
	   ...
	   public static void main(String[] args) throws Exception //if still OOM subtract as you bring it in
	   {
	      ...
	      */
	      ...
	      iterations = new ArrayList<InstanceHamming>(); //iterations
	      ...
	      {      
	         ...
	         {
	              int a=0;
	          Double[][][] matrix = new Double[nFrames][nRows][nCols]; 
	            
	            filename= "/Users/rdhumne/Documents/GMUInternship2015/S7_txt/S7_"+ dataFile + (j+3)+ "_"+ (x+1) + "_f" + (a+1) + ".txt"; //getting textfile //add NewMotions/
	            ...
	            { 
	               ...
	               for(int z=0; z<nRows; z++) //for every row
	               {
	                  ...
	                  for(int c=0; c<cols.length-1; c++)
	                     {
	                    	   matrix[a][z][c]= Double.parseDouble(cols[c+1]);
	                     }
	             ...
	             filename= "/Users/rdhumne/Documents/GMUInternship2015/S7_txt/S7_"+ dataFile + (j+3)+ "_"+ (x+1) + "_f" + (a+1) + ".txt";
	   
	             file = new File(filename); 
	            } 
	            InstanceHamming I = new InstanceHamming(matrix,j);
	            iterations.add(I);
	      ...
	      System.out.println("correlationTime:" + (double)corrTime / 1000000000/(55*54));
	      System.out.println("patternTime:" + (double)patternTime / 1000000000/(55*55));
	     // System.out.println("classificationTime:" + (double)classTime / 1000000000/10);
	      
	   }
	  
	   
	  public static void report(ArrayList<InstanceHamming> iterations)
	   {
	   ...
	   } public static int nearestNeighbor(int test, ArrayList<InstanceHamming> train)
	   {
	   
		   ArrayList<Double> corrs = new ArrayList<Double>();
		      ArrayList<Integer> ccs = new ArrayList<Integer>(); //classes
		      double time1 = System.nanoTime();
		     Integer[][] avg1 =iterations.get(test).task3();
		      double time2=System.nanoTime();
